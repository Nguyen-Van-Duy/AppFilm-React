...
const Movies = () => {
    ...
    const dataFilm = useSelector(state => state.datafilm.dataFilm).phimchieurap;
    // const listDataFilm = [];
    ...
    return (
        <Card>
            <div className="container__list-film">
                <div className="row">
                    <div className="col l-9-6 l-12"><MovieGenre listData={dataFilm} title='PHIM CHIẾU RẠP' /></div>
